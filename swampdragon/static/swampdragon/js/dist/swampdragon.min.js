(function (e) {
    if (typeof exports == "object" && typeof module != "undefined")module.exports = e(); else if (typeof define == "function" && define.amd)define([], e); else {
        var t;
        typeof window != "undefined" ? t = window : typeof global != "undefined" ? t = global : typeof self != "undefined" ? t = self : t = this, t.swampdragon = e()
    }
})(function () {
    ...
    return function e(t, n, r) {
        ...
        function o(e, t) {
            var n;
            if (e in r) {
                for (n = 0; n < r[e].length; n += 1)if (r[e][n] === t)return;
                r[e].push(t)
            } else r[e] = [t]
        }
        ...
        function f(e) {
            var t = e.remote_channels, n;
            if(e.remote_channels)
                n = e.remote_channels.length;
            for (var r = 0; r < n; r += 1)e.action === i && o(t[r], e.local_channel), e.action === s && u(t[r], e.local_channel)
        }

        var r = {}, i = "subscribe", s = "unsubscribe";
        t.exports = {setupChannels: f, getLocalChannels: a}
    }, {}], 2: [function (e, t, n) {
        function f() {
            var e = window.swampdragon_host, t = window.swampdragon_settings.endpoint;
            return t.indexOf("/") != 0 && (t = "/" + t), e += t, e
        }

        function l() {
            o.socket = new SockJS(f()), o.socket.onopen = c, o.socket.onclose = h, o.socket.onmessage = p
        }

        function c() {
            connectionAttempt = 0, u = !0, r.emit("open"), r.emitOnce("ready")
        }

        function h(e) {
            o.socket = null, u = !1, connectionAttempt === 0 && r.emit("close");
            if (e.code == 3001)return;
            setTimeout(function () {
                connectionAttempt < 10 && (connectionAttempt++, l())
            }, connectionAttempt * 500 + 100)
        }

        function p(e) {
            "data"in e && typeof e.data != "object" && (e.data = JSON.parse(e.data)), "data"in e && "context"in e.data && "client_callback_name"in e.data.context && r.emit(e.data.context.client_callback_name, [e.data.context, e.data.data]);
            if ("channel_data"in e.data) {
                var t = e.data.channel_data, n;
                s.setupChannels(t)
            }
            if ("channel"in e.data) {
                var i = s.getLocalChannels(e.data.channel);
                delete e.data.channel, r.emit("channelMessage", [i, e.data]);
                return
            }
            if ("data"in e && "heartbeat"in e.data && e.data.heartbeat == 1) {
                o.socket.send(JSON.stringify(e.data)), r.emit("heartbeat", [channel, e.data]);
                return
            }
            r.emit("message", e)
        }
        ...
        e("sockjs");
        var r = e("./event-handler"), i = e("./message-handler"), s = e("./channels"), o = {}, u = !1, a = 0;
        l(), t.exports = {sockjs: o, onopen: o.onopen, send: o.send, ready: function () {
            return u
        }, on: r.on}
    }, {"./channels": 1, "./event-handler": 3, "./message-handler": 4, sockjs: 6}], 3: [function (e, t, n) {
        function i() {
            var e = "cb_" + callbackId;
            return callbackId += 1, callbackId > 999999 && (callbackId = 0), e
        }
        ...
        function o(e, t) {
            ...
            for (i = 0; i < n.length; i += 1)s = n[i], s.apply(this, t);
            return n.length
        }
        ...
        var r = {};
        callbackId = 0, t.exports = {on: s, emit: o, emitOnce: u, getCallbackName: i}
    }, {}], 4: [function (e, t, n) {
        var r = function (e) {
            "data"in e && typeof e.data != "object" && (e.data = JSON.parse(e.data)), "data"in e && "context"in e.data && "client_callback_name"in e.data.context && swampDragon.emit(e.data.context.client_callback_name, [e.data.context, e.data.data]);
            if ("channel_data"in e.data) {
                var t = e.data.channel_data;
                for (i in t.remote_channels)remote_chan = t.remote_channels[i], remote_chan in swampDragon.channels || (swampDragon.channels[remote_chan] = []), t.local_channel in swampDragon.channels[remote_chan] || swampDragon.channels[remote_chan].push(t.local_channel);
                t.local_channel in swampDragon.channels || (swampDragon.channels[t.remote_channel] = t.local_channel)
            }
            if ("channel"in e.data) {
                var n = swampDragon.channels[e.data.channel];
                delete e.data.channel, swampDragon.settings.onchannelmessage(n, e.data);
                return
            }
            "data"in e && "heartbeat"in e.data && e.data.heartbeat == 1 && (swampDragon.send(JSON.stringify(e.data)), swampDragon.settings.onheartbeat()), settings.onmessage(e)
        };
        t.exports = r
    }, {}], 5: [function (e, t, n) {
        var r = e("./connection"), i = e("./event-handler"), s = s || {};
        s.open = function (e) {
            r.ready() ? e() : r.on("open", e)
        }, s.close = function (e) {
            r.on("close", e)
        }, s.ready = function (e) {
            r.ready() ? e() : r.on("ready", e)
        }, s.onChannelMessage = function (e) {
            i.on("channelMessage", e)
        }, s.send = function (e) {
            return r.sockjs.socket.send(e)
        }, s.sendJSON = function (e) {
            return s.send(JSON.stringify(e))
        }, s.callRouter = function (e, t, n, r, o, u) {
            var a = i.getCallbackName();
            u != null && (n = n || {}, n.channel = u), i.on(a, function (e, t) {
                e.state == "success" && r && r(e, t), e.state == "error" && o && o(e, t)
            }), s.sendJSON({route: t, verb: e, args: n, callbackname: a})
        }, s.subscribe = function (e, t, n, r, i) {
            return s.callRouter("subscribe", e, n, r, i, t)
        }, s.unsubscribe = function (e, t, n, r, i) {
            return s.callRouter("unsubscribe", e, n, r, i, t)
        }, s.getSingle = function (e, t, n, r) {
            s.callRouter("get_single", e, t, n, r, null)
        }, s.getList = function (e, t, n, r) {
            s.callRouter("get_list", e, t, n, r, null)
        }, s.getPagedList = function (e, t, n, r, i) {
            n = n || 1, t._page = n, s.callRouter("get_list", e, t, r, i, null)
        }, s.create = function (e, t, n, r) {
            s.callRouter("create", e, t, n, r, null)
        }, s.update = function (e, t, n, r) {
            s.callRouter("update", e, t, n, r, null)
        }, s["delete"] = function (e, t, n, r) {
            s.callRouter("delete", e, t, n, r, null)
        }, t.exports = s
        ...
        (function (global) {
            __browserify_shim_require__ = require, function browserifyShim(module, exports, require, define, browserify_shim__define__module__export__) {
                ...
                JSON || (JSON = {}), function () {
                        ...
                        switch (typeof a) {
                            ...
                            case"object":
                                ...
                                if (rep && typeof rep == "object") {
                                    s = rep.length;
                                    for (n = 0; n < s; n += 1)typeof
                                        rep[n] == "string" && (r = rep[n], i = str(r, a), i && u.push(quote(r) + (gap ? ": " : ":") + i))
                    ...
                    r.prototype.addEventListener = function (e, t) {
                        ...
                        var r = this._listeners[e], i = n.arrIndexOf(r, t);
                        if (i !== -1) {
                        ...
                        if (this._listeners && t in this._listeners)for (var r = 0; r < this._listeners[t].length; r++)this._listeners[t][r].apply(this, n)
                    };
                    var i = function (e, t) {
                        this.type = e;
                        if (typeof t != "undefined")for (var n in t) {
                    ...
                    s.prototype.emit = function (e) {
                        ...
                        if (e in t._listeners)for (var r = 0; r < t._listeners[e].length; r++)t._listeners[e][r].apply(t, n)
                    ...
                    var a = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, f = {"\0": "\\u0000", "": "\\u0001", "": "\\u0002", "": "\\u0003", "": "\\u0004", "": "\\u0005", "": "\\u0006", "": "\\u0007", "\b": "\\b", "	": "\\t", "\n": "\\n", "": "\\u000b", "\f": "\\f", "\r": "\\r", "": "\\u000e", "": "\\u000f", "": "\\u0010", "": "\\u0011", "": "\\u0012", "": "\\u0013", "": "\\u0014", "": "\\u0015", "": "\\u0016", "": "\
17\u1b6b\u1cda-\u1cdb\u1dc0-\u1dcf\u1dfc\u1dfe\u1f71\u1f73\u1f75\u1f77\u1f79\u1f7b\u1f7d\u1fbb\u1fbe\u1fc9\u1fcb\u1fd3\u1fdb\u1fe3\u1feb\u1fee-\u1fef\u1ff9\u1ffb\u1ffd\u2000-\u2001\u20d0-\u20d1\u20d4-\u20d7\u20e7-\u20e9\u2126\u212a-\u212b\u2329-\u232a\u2adc\u302b-\u302c\uaab2-\uaab3\uf900-\ufa0d\ufa10\ufa12\ufa15-\ufa1e\ufa20\ufa22\ufa25-\ufa26\ufa2a-\ufa2d\ufa30-\ufa6d\ufa70-\ufad9\ufb1d\ufb1f\ufb2a-\ufb36\ufb38-\ufb3c\ufb3e\ufb40-\ufb41\ufb43-\ufb44\ufb46-\ufb4e\ufff0-\uffff]/g, c, h = JSON && JSON.stringify || function (e) {
                    ...
                    n.attachEvent("unload", b), n.unload_add = function (e) {
                        ...
                        var i = e.createElement("iframe"), s, o, u = function () {
                            clearTimeout(s);
                            try {
                                i.onload = null
                            } catch (e) {
                        ...
                        return i.src = t, i.style.display = "none", i.style.position = "absolute", i.onerror = function () {
                            ...
                            f("timeout")
                        }, 15e3), o = n.unload_add(a), {post: l, cleanup: a, loaded: u}
                    }, n.createHtmlfile = function (e, r) {
                        var i = new ActiveXObject("htmlfile"), s, o, a, f = function () {
                            clearTimeout(s)
                        }, l = function () {
                        ...
                        return i.body.appendChild(p), a = i.createElement("iframe"), p.appendChild(a), a.src = e, s = setTimeout(function () {
                            c("timeout")
                        }, 15e3), o = n.unload_add(l), {post: h, cleanup: l, loaded: f}
                    };
                    var w = function () {
                    };
                    w.prototype = new s(["chunk", "finish"]), w.prototype._start = function (e, r, i, s) {
                        ...
                        if (s && s.headers)for (var f in s.headers)o.xhr.setRequestHeader(f, s.headers[f]);
                    ...
                    var S = n.XHRLocalObject = function (e, t, r) {
                        var i = this;
                        n.delay(function () {
                            i._start(e, t, r, {no_credentials: !0})
                        })
                    };
                    S.prototype = new w;
                    ...
                    x.prototype = new s(["chunk", "finish"]), x.prototype._start = function (e, t, r) {
                        var i = this, s = new XDomainRequest;
                    ...
                    T.prototype = new r, T.version = "0.3.4", T.CONNECTING = 0, T.OPEN = 1, T.CLOSING = 2, T.CLOSED = 3, T.prototype._debug = function () {
                        ...
                        t.dispatchEvent(new i("message", {data: e}))
                        ...
                        var o = new i("close", {code: e, reason: t, wasClean: n.userSetCode(e)});
                        if (!n.userSetCode(e) && s.readyState === T.CONNECTING && !r) {
                            if (s._try_next_protocol(o))return;
                            o = new i("close", {code: 2e3, reason: "All transports failed", wasClean: !1, last_event: o})
                        }
                        ...
                        for (; ;) {
                            ...
                            if (!i)return!1;
                            if (T[i] && T[i].need_body === !0 && (!e.body || typeof e.readyState != "undefined" && e.readyState !== "complete"))return r.
                                _protocols.unshift(i), r.protocol = "waiting-for-load", n.attachEvent("load", function () {
                                r._try_next_protocol()
                            }), !0;
                            if (!!T[i] && !!T[i].enabled(r._options)) {
                                var s = T[i].roundTrips || 1, o = (r._options.rto || 0) * s || 5e3;
                                r._transport_tref = n.delay(o, function () {
                                    r.readyState === T.CONNECTING && r._didClose(2007, "Transport timeouted")
                                });
                                var u = n.random_string(8), a = r._base_url + "/" + r._server + "/" + u;
                    ...
                    var k = function (t, r, i) {
                        var s = this;
                        if (!("_send_form"in s)) {
                            var o = s._send_form = e.createElement("form"), u = s._send_area = e.createElement("textarea");
                        ...
                        var o = s._send_form, u = s._send_area, a = "a" + n.random_string(8);
                        ...
                        var i, s = e.createElement("script"), o, u = function (e) {
                        ...
                        if (typeof s.async == "undefined" && e.attachEvent)if (!/opera/i.test(navigator.userAgent)) {
                            try {
                    ...
                    var M = function (e, r, i) {
                        var s = "a" + n.random_string(6), o = e + "?c=" + escape(u + "." + s), a = 0, f = function (e) {
                            switch (a) {
                                case 0:
                                    delete t[u][s], i(e);
                                    break;
                    ...
                    j.prototype.i_constructor = function (e, t, r) {
                        ...
                        var n = e.data.slice(0, 8), r = e.data.slice(8, 9), i = e.data.slice(9);
                    ...
                    q.prototype._didClose = function (e, t) {
                        ...
                        var i = function (e) {
                            ...
                            switch (s) {
                                case"s":
                                    var u = JSON.parse(o), a = u[0], f = u[1], l = u[2], c = u[3];
                    ...
                    R.prototype = new s(["finish"]), R.prototype.doXhr = function (e, t) {
                        var r = this, i = (new Date).getTime(), s = new t("GET", e + "/info"), o = n.delay(8e3, function () {
                            s.ontimeout()
                        });
                        s.onfinish = function (e, t) {
                            clearTimeout(o), o = null;
                            if (e === 200) {
                                var n = (new Date).getTime() - i, s = JSON.parse(t);
                        ...
                        var r = this, i = function () {
                            ...
                            var n = function (t) {
                                if (typeof t == "string" && t.substr(0, 1) === "m") {
                                    var n = JSON.parse(t.substr(1)), i = n[0], s = n[1];
                                    r.emit("finish", i, s)
                                } else r.emit("finish");
                                e.doCleanup(), e = null
                            }, i = {_options: {}, _didClose: n, _didMessage: n};
                    ...
                    var Z = function (e) {
                        ...
                        r.onmessage = function (e) {
                            t.dispatchEvent(new i("message", {data: unescape(e.data)}))
                            ...
                            t.es_close = r.onmessage = r.onerror = null, r.close(), r = null, n.delay(200, function () {
                                t.dispatchEvent(new i("close", {reason: o}))
                            })
                        }
                    };
                    ...
                    var et, tt = function () {
                        if (et === undefined)if ("ActiveXObject"in t)try {
                        ...
                        var s = tt() ? n.createHtmlfile : n.createIframe, o;
                        t[u][r.id] = {start: function () {
                            o.loaded()
                        }, message: function (e) {
                            r.dispatchEvent(new i("message", {data: e}))
                        }, stop: function () {
                            r.iframe_close({}, "network")
                        }}, r.iframe_close = function (e, n) {
                            o.cleanup(), r.iframe_close = o = null, delete t[u][r.id], r.dispatchEvent(new i("close", {reason: n}))
                        }, o = s(e, function (e) {
                    ...
                    var rt = function (e, t) {
                        ...
                        n.xo = new t("POST", e, null), n.xo.onchunk = function (e, t) {
                            if (e !== 200)return;
                            for (; ;) {
                                var s = t.slice(r), o = s.indexOf("\n");
                                if (o === -1)break;
                                r += o + 1;
                                var u = s.slice(0, o);
                                n.dispatchEvent(new i("message", {data: u}))
                            }
                        }, n.xo.onfinish = function (e, t) {
                            n.xo.onchunk(e, t), n.xo = null;
                            var r = e === 200 ? "network" : "permanent";
                            n.dispatchEvent(new i("close", {reason: r}))
                        }
                    };
                    return rt.prototype = new r, rt.prototype.abort = function () {
                        var e = this;
                        e.xo && (e.xo.close(), e.dispatchEvent(new i("close", {reason: "user"})), e.xo = null)
                    }, T.getUtils = function () {
                        return n
            ...
            }.call(global, undefined, undefined, undefined, undefined, function (t) {
                    module.exports = t
                })
